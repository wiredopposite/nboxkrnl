...
ULONG KernelThunkTable[379] =
{
	...
	(ULONG)FUNC(&ExInterlockedAddLargeInteger),            // 0x0013 (19)
	(ULONG)FUNC(&ExInterlockedAddLargeStatistic),          // 0x0014 (20)
	(ULONG)FUNC(&ExInterlockedCompareExchange64),          // 0x0015 (21)
	...
	(ULONG)FUNC(&ExSemaphoreObjectType),               // 0x001E (30)
	(ULONG)FUNC(&ExTimerObjectType),                   // 0x001F (31)
	(ULONG)FUNC(&ExfInterlockedInsertHeadList),            // 0x0020 (32)
	(ULONG)FUNC(&ExfInterlockedInsertTailList),            // 0x0021 (33)
	(ULONG)FUNC(&ExfInterlockedRemoveHeadList),            // 0x0022 (34)
	...
	(ULONG)FUNC(&InterlockedExchangeAdd),            // 0x0037 (55)
	(ULONG)FUNC(&InterlockedFlushSList),             // 0x0038 (56)
	(ULONG)FUNC(&InterlockedPopEntrySList),          // 0x0039 (57)
	(ULONG)FUNC(&InterlockedPushEntrySList),         // 0x003A (58)
	...
	(ULONG)FUNC(&KeAlertResumeThread),                     // 0x005C (92)
	(ULONG)FUNC(&KeAlertThread),                           // 0x005D (93)
	...
	(ULONG)FUNC(&KeCancelTimer),                           // 0x0061 (97)
	...
	(ULONG)FUNC(&KeInitializeQueue),                       // 0x006F (111)
	...
	(ULONG)FUNC(&KeInsertHeadQueue),                       // 0x0074 (116)
	(ULONG)FUNC(&KeInsertQueue),                           // 0x0075 (117)
	...
	(ULONG)FUNC(&KeResetEvent),                            // 0x008A (138)
	...
	(ULONG)FUNC(&NtPulseEvent),                            // 0x00CD (205)
	...
	(ULONG)FUNC(&NtQueryEvent),                            // 0x00D1 (209)
	...
	(ULONG)FUNC(&NtSetEvent),                              // 0x00E1 (225)
	...
	(ULONG)FUNC(&RtlAppendUnicodeToString),                // 0x0107 (263)
	...
	(ULONG)FUNC(&RtlCompareUnicodeString),                 // 0x010F (271)
	(ULONG)FUNC(&RtlCopyString),                           // 0x0110 (272)
	(ULONG)FUNC(&RtlCopyUnicodeString),                    // 0x0111 (273)
	(ULONG)FUNC(&RtlCreateUnicodeString),                  // 0x0112 (274)
	(ULONG)FUNC(&RtlDowncaseUnicodeChar),                  // 0x0113 (275)
	(ULONG)FUNC(&RtlDowncaseUnicodeString),                // 0x0114 (276)
	...
	(ULONG)FUNC(&RtlEqualUnicodeString),                   // 0x0118 (280)
	...
	(ULONG)FUNC(&RtlFreeAnsiString),                       // 0x011E (286)
	...
	(ULONG)FUNC(&RtlInitUnicodeString),                    // 0x0122 (290)
	...
	(ULONG)FUNC(&RtlMultiByteToUnicodeSize),               // 0x012C (300)
	...
	(ULONG)FUNC(&RtlUnicodeStringToAnsiString),            // 0x0134 (308)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlUnicodeStringToInteger),               // 0x0135 (309)
	(ULONG)FUNC(&RtlUnicodeToMultiByteN),                  // 0x0136 (310)
	(ULONG)FUNC(&RtlUnicodeToMultiByteSize),               // 0x0137 (311)
	(ULONG)FUNC(&RtlUnwind),                               // 0x0138 (312)
	(ULONG)FUNC(&RtlUpcaseUnicodeChar),                    // 0x0139 (313)
	(ULONG)FUNC(&RtlUpcaseUnicodeString),                  // 0x013A (314)
	(ULONG)FUNC(&RtlUpcaseUnicodeToMultiByteN),            // 0x013B (315)
	...
	(ULONG)FUNC(&RtlSnprintf),                             // 0x0169 (361)
	(ULONG)FUNC(&RtlSprintf),                              // 0x016A (362)
	(ULONG)FUNC(&RtlVsnprintf),                            // 0x016B (363) 
	(ULONG)FUNC(&RtlVsprintf),                             // 0x016C (364)
